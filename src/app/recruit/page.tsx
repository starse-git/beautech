...
const RecruitPage = () => {
  const jobData: JobItem[] = [
    ...
    {
      title: "仕事内容",
      desp: "資料作成などの事務業務全般をお任せします。基本的なPCスキル（Excel・Word）や、電話応対など一般的なビジネスマナーがあれば、はじめられる仕事です。書類チェックや電話・来客対応等のサポート業務を通して、会社を支えていただく仕事です。まずは簡単な業務からはじめ、徐々にステップアップ。未経験でもしっかりなくスートできます！",
    },
    {
      title: "求人情報",
      desp: "2名",
    ...
    {
      title: "採用部門",
      desp: "学部（文系・理系）は問いません。",
    },
    {
      title: "基本給",
      desp: "学士（東京勤務）200,000円（月額手当含む）",
    },
    {
      title: "手当",
      desp: "時間外手当、交通費全額支給 など",
    },
    {
      title: "賞与",
      desp: "年2回（7月、12月）",
    ...
    {
      title: "勤務地",
      desp: "東京、神奈川県、千葉県、埼玉県",
    },
    {
      title: "勤務時間",
      desp: "09:00〜18:00 ※配属会により異なります。",
    },
    {
      title: "福利厚生",
      desp: "健康保険、厚生年金、雇用保険、労災保険、退職金制度、各種保険組合",
    },
    {
      title: "教育制度",
      desp: "OJT、社内講座、グローバル言語（日本語・英語）通信など",
    },
    {
      title: "休日/休暇",
      desp: "週休2日制（土・日）、有給休暇（初年度10日付与）、産前産後特別休暇、育児休暇",
    },
    {
      title: "面接",
      desp: "一次試験 → 二次試験（選考方法は勤務地により変更になる場合があります）",
    },
    {
      title: "ドキュメント",
      desp: "履歴書、卒業見込証明書、成績証明書、他社の就職証明書",
    },
  ];
  return (
      ...
      <div className="container my-20 md:my-40">
        ...
        <div>
          <div className="flex items-center justify-center mb-10 md:mb-16">
            <TitleBorderComponent text="事務・営業" />
          </div>
